...
def produce_all_cutouts(targets, status_folder, src_beam_map, delay, max_loops=500):
    ...
    if len(remaining_array_ids) > 0:
        ...
        print('\nCompleted processing in {} loops with average concurrency {:.2f}'.format(
            i, total_concurrency/len(targets)))
...
def main():
    ...
    produce_all_cutouts(targets, args.status_folder,
                        src_beam_map, args.delay, max_loops=args.max_loops)
